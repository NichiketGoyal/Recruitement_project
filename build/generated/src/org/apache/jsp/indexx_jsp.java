...
public final class indexx_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t<link rel=\"stylesheet\" type=\"text/css\" href=\"stylee.css\">\n");
      out.write("    </head>\n");
      ...
      out.write("                                    <input type=\"submit\" name=\"account\" class=\"account\" value=\"Sign Up Now !\" >\n");
      out.write("\t\t\t\t</div>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t<form action=\"Login\"  class=\"form-detail\"  method=\"post\" id=\"myform\">\n");
      out.write("\t\t<center><h2>SIGN-IN</h2></center>\n");
      out.write("\t\t\t<div class=\"form-row\">\n");
      out.write("\t\t\t\t<label for=\"your_email\">Your Email</label>\n");
      out.write("\t\t\t\t\t<input type=\"text\" name=\"ye\" id=\"your_email\" class=\"input-text\"  required pattern=\"[^@]+@[^@]+.[a-zA-Z]{2,6}\">\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t\t<div class=\"form-group\">\n");
      out.write("\t\t\t\t\t<div class=\"form-row form-row-1 \">\n");
      out.write("\t\t\t\t\t\t<label for=\"password\">Password</label>\n");
      out.write("\t\t\t\t\t\t<input type=\"password\" name=\"pw\" id=\"password\"  class=\"input-text\" required>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
